KtorとReactを使ったKotlin Multiplatformアプリケーションを作ってみました
練習用なので実用性はないです

フロントエンドとバックエンドで型定義やらバリデーションロジックを共有してるのでそれなりによさげなDXになってます  
フロントエンドはほとんどGitHub Copilotに任せました

以下、プロジェクト生成時のテンプレートREADME
